...
-- Theory Questions (System Design & Technical)
('Design a URL Shortener', 'Theory', 'Medium', 'Design a URL shortening service like bit.ly. Your system should be able to:
...
('Describe a time when you had to learn a new technology quickly', 'Behavioral', 'Easy', 'Tell me about a situation where you had to quickly pick up a new programming language, framework, or technology to complete a project. How did you approach the learning process?', 'Focus on learning strategies, time management, and how you applied the new knowledge effectively.', NULL, NULL, NULL, 'software'),

('How do you handle code review feedback?', 'Behavioral', 'Easy', 'Describe your approach to giving and receiving code review feedback. How do you ensure constructive discussions and maintain team collaboration?', 'Emphasize growth mindset, constructive communication, and team dynamics.', NULL, NULL, NULL, 'software'),
