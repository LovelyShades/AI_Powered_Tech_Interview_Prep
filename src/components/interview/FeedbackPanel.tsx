...
export const FeedbackPanel = ({ 
  ...
  return (
    <Card className="mt-6 bg-white/80 backdrop-blur-md border border-blue-200/50 shadow-xl">
      <CardHeader>
      ...
      <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-2 max-h-40 overflow-y-auto">
                {testResults.details.map((test, i) => (
                  <div key={i} className="flex items-start gap-2 text-sm bg-slate-50 border border-slate-200 p-3 rounded-lg">
                    {test.passed ? (
        ...
        {solution && (
          <div>
            <h4 className="font-medium mb-3 text-slate-800">Solution Approach</h4>
            <div className="bg-slate-50 border border-slate-200 p-4 rounded-lg">
              <pre className="text-sm overflow-x-auto">
                <code className="language-javascript whitespace-pre-wrap text-slate-700">
                  {solution}
                </code>
              </pre>
            </div>
